...
const Payment = ({currentUser}) => {
    ...
    return (
        <React.Fragment>
            ...
            {!planType ? (
                <FrontLayout>
                    <Plan handlePlanType={handlePlanType} user={currentUser} change={false}/>
                </FrontLayout> 
            ) : (
                <FrontLayout>
                    <Checkout handleType={handlePlanType} planType={planType} user={currentUser} change={false}/>
                </FrontLayout>
            )}
        </React.Fragment>
    );
...
export const getServerSideProps = async(context) => {
    return getServerProps(context,{},"PAYMENT:VIEW",{isNotMember: true});
}
